    ...
    <button @click="fetchData">Fetch Data</button>
      ...
      <table v-if="pollutionData">
        <thead>
          <tr>
            <th>State</th>
            <th>Days Exceeding Ozone Pollutant Standard Value</th>
  ...
  export default {
    ...
    methods: {
      async fetchData() {
        ...
        try {
          const response = await axios.get('http://localhost:8000/ozone/' + newOp + '/' + newValue); // Update the URL with your server's actual address
